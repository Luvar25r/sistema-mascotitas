...
public class ServicioDesparasitacion extends Servicio {

    public ServicioDesparasitacion() {
        super("Desparasitación", "Servicio de desparasitación para mascotas", 200.0);
    }
